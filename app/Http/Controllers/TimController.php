...
class TimController extends Controller
{
    ...
    {
        $pernum = TimDetail::all('nip')->toArray();
        $data = Tim::all();
    ...
    public function multiDelete(Request $request){
        ...
        $deleteTimDetail = TimDetail::where('tim_id', '=', $request->tim_id);
        $deleteTimDetail->delete();

        $deletePenilaianTim = PenilaianTim::where('tim_id', '=', $request->tim_id);
        $deletePenilaianTim->delete();

        $allTim = Tim::findOrFail($request->tim_id);
        $deleteAllTim = Tim::where('id', '=', $allTim->id);
        $deleteAllTim->delete();
