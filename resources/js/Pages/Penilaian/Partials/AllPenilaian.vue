    ...
    methods: {
        ...
        searchTerm(){
            if(this.term == 'semua' || this.term == ''){
                this.$inertia.get(this.route('penilaian.index', {allTerm: '', allPeriode:''}, {preserveState:true, replace:true}));
                this.getData();
            }else{
                this.$inertia.get(this.route('penilaian.index', {allTerm: this.term, allPeriode:this.form.periode}, {preserveState:true, replace:true}));
                this.getData();
            }
        ...
        searchPeriode(){
            if(this.bulan == 'semua' || this.bulan == ''){
                this.$inertia.get(this.route('penilaian.index', {allTerm:this.term, allPeriode: ''}, {preserveState:true ,replace:true}));
                this.getData();
            }else{
                this.$inertia.get(this.route('penilaian.index', {allTerm:this.term, allPeriode: this.form.periode}, {preserveState:true ,replace:true}));
                this.getData();
