<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:pt-0 bg-transparent">
                <lambang />
            </div>

            <div class="px-4 py-2  text-base rounded-full text-purple-800 border border-green-600 undefined text-center">
                <span class="">
                    Aplikasi Penilaian 5P
                </span>
            </div>
        </div>
    </div>
...
<script>
    ...
    import Lambang from '@/Jetstream/ApplicationLogo.vue'
